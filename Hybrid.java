...
//public class Hybrid extends business_supply_inventory {
// public static void main(String[] args) {
public class Hybrid extends business_supply_inventory {
	     
		 //business_supply_inventory obj2 = new Hybrid();
	     //obj2.display();
	     //System.out.print(obj2.count);
	...
	Hybrid(int inventoryID, int count, int supplyLevel, int price, String myModel, String myMake, int myYear){ 
	...
	//public methods for private strings 
	...
	//public String toString() { 
		//return "SupplyNeeded:" + this.supplyLevel + " Model:" + this.model + " Make:" + this.make  + " Year:" + this.year;
	//}
