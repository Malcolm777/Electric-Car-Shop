# Electric-Car-Shop
Program will print out each list to document the inventory for the buyer so they can re-order supplies that are low

Changes the super class to an abstract class 
